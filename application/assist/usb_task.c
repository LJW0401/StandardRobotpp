...
static void usb_send_outputPC(uint8_t t)
{
    ...
    char_to_uint(OutputPCData.packets[8].name, "reach0");
    char_to_uint(OutputPCData.packets[9].name, "reach1");
    char_to_uint(OutputPCData.packets[10].name, "reach2");
    char_to_uint(OutputPCData.packets[11].name, "reach3");
    char_to_uint(OutputPCData.packets[12].name, "velfdb0");
